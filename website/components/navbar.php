                        ...
                        <div class="main_menu menu_position">
                            <nav>
                                <ul>
                                    ...
                                    <li>
                                        <a class="<?php if($page=="plant_page"){echo "active";} ?>" href="plants.php">Plants</a>
                                    </li>
                                    <li>
                                        <a class="<?php if($page=="cart_page"){echo "active";} ?>" href="cart.php">Cart</a>
                                    </li>
                                    <li>
                                        <a class="<?php if($page=="contact_page"){echo "active";} ?>" href="contact.php"> Contact Us</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
